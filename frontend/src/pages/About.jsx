  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 flex-grow">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold bg-gradient-to-r from-brand-primary to-brand-accent bg-clip-text text-transparent mb-4">About DTClassess</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="bg-brand-nav p-8 rounded-2xl border border-brand-accent/20 glow-effect">
          ...
          <p className="text-brand-muted leading-relaxed mb-6">
            Trading the financial markets can be daunting. Our mission is to demystify the stock market and provide structured, actionable education. Whether you are a complete beginner or an experienced trader looking to refine your edge, DTClassess offers the resources you need.
          </p>
